...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240428113131_add-new-table-LittlePatientAdultPatientMap")]
    partial class addnewtableLittlePatientAdultPatientMap
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Classes.AppDBClasses.BirthCertificate", b =>
                {
                    b.Property<int>("LittlePatientId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Classes.AppDBClasses.LittlePatient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LittlePatients");
                });

            modelBuilder.Entity("Domain.Classes.AppDBClasses.LittlePatientAdultPatientMap", b =>
                {
                    ...
                    b.HasKey("AdultPatientId", "LittlePatientId");

                    b.HasIndex("AdultPatientId")
                        .IsUnique();

                    b.HasIndex("LittlePatientId")
                        .IsUnique();

                    b.ToTable("LittlePatientAdultPatientMaps");
                });
            ...
            modelBuilder.Entity("Domain.Classes.AppDBClasses.Address", b =>
                {
                    ...
                    b.HasOne("Domain.Classes.AppDBClasses.LittlePatient", "LittlePatient")
                        .WithMany("Addresses")
                        .HasForeignKey("PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Classes.AppDBClasses.BirthCertificate", b =>
                {
                    b.HasOne("Domain.Classes.AppDBClasses.LittlePatient", "LittlePatient")
                        ...
                        .HasForeignKey("Domain.Classes.AppDBClasses.BirthCertificate", "LittlePatientId")
            ...
            modelBuilder.Entity("Domain.Classes.AppDBClasses.LittlePatientAdultPatientMap", b =>
                {
                    b.HasOne("Domain.Classes.AppDBClasses.AdultPatient", "AdultPatient")
                        .WithOne("LittlePatientAdultPatientMap")
                        .HasForeignKey("Domain.Classes.AppDBClasses.LittlePatientAdultPatientMap", "AdultPatientId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Domain.Classes.AppDBClasses.LittlePatient", "LittlePatient")
                        .WithOne("LittlePatientAdultPatientMap")
                        .HasForeignKey("Domain.Classes.AppDBClasses.LittlePatientAdultPatientMap", "LittlePatientId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Classes.AppDBClasses.AdultPatient", b =>
                {
                    ...
                    b.Navigation("LittlePatientAdultPatientMap")
                        .IsRequired();
